...
namespace Example10_2
{
    public partial class frmInventory : Form
    {
        ...
        private void InventoryForm_Load(object sender, EventArgs e)
        {
            ...
            inventoryConnection = new SqlConnection("Data Source=.\\SQLEXPRESS; AttachDbFilename=C:\\Database\\SQLInventoryDB1.mdf; Integrated Security=True; Connect Timeout=30; User Instance=True;");
            ...
            txtLocation.DataBindings.Add("Text",
            inventoryTable, "Location");
            txtStore.DataBindings.Add("Text", inventoryTable, "Store");
            dtpDatePurchased.DataBindings.Add("Text",
            inventoryTable, "DatePurchased");
            txtPurchaseCost.DataBindings.Add("Text",
            inventoryTable, "PurchaseCost");
            txtSerialNumber.DataBindings.Add("Text",
            inventoryTable, "SerialNumber");
            chkEngraved.DataBindings.Add("Checked",
            inventoryTable, "Engraved");
            lblPhotoFile.DataBindings.Add("Text",
            inventoryTable, "PhotoFile");
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                inventoryTable.Rows[inventoryManager.Count - 1]
                ["Engraved"] = chkEngraved.Checked;
                chkEngraved.DataBindings.Add("Checked",
                inventoryTable, "Engraved");
            }
...
(int)e.KeyChar == 8)
        ...
        private void PrintInventory(object sender,
PrintPageEventArgs e)
        {
            ...
            y +=
            Convert.ToInt32(myFont.GetHeight(e.Graphics));
            e.Graphics.DrawString("Location:", myFont,
            Brushes.Black,
            e.MarginBounds.X, y);
            ...
            Brushes.Black, e.MarginBounds.X, y);
            e.Graphics.DrawString(dtpDatePurchased.Text,
            myFont,
            Brushes.Black, e.MarginBounds.X + 150, y);
            y +=
            Convert.ToInt32(myFont.GetHeight(e.Graphics));
            ...
            e.Graphics.DrawImage(picItem.Image,e.MarginBounds.X, y,
            400, h);
            pageNumber++;
