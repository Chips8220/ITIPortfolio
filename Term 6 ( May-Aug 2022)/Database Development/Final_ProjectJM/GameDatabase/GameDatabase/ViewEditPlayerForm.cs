    ...
    public partial class frmGameDB : Form
    {
        ...
        private void frmGameDB_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                b = new SqlCommandBuilder(gamedbAdapter);
        ...
        private void btnAddNew_Click(object sender, EventArgs e)
        {
            ...
            {
                gamedbManager.AddNew();
                txtPName.Text = a.newplayername;
                txtHP.Text = 100 +"";
                txtMP.Text = 100 + "";
                txtLDamage.Text = 1 + "";
                txtHDamage.Text = 10 + "";
        ...
        {
            Query q = new Query();
            DialogResult dialogResult = q.ShowDialog();
            if (dialogResult == DialogResult.OK)
            {
                
                SqlCommand NewQuery = new SqlCommand(q.query, gamedbConnection);
                gamedbAdapter.SelectCommand = NewQuery;
