...
Public Class frmMain
    Private Sub btnCalc_Click(sender As Object, e As EventArgs) Handles btnCalc.Click
        ...
        ' Assign length and width to the object's variables.
        Integer.TryParse(lstLength.SelectedItem.ToString, intDeckLen)
        Integer.TryParse(lstWidth.SelectedItem.ToString, intDeckWid)
