...
Public Class frmMain
    ...
    Private Sub GetSingleFwt(ByVal dblTaxPay As Double, ByRef dblFedWthTax As Double)
        Select Case dblTaxPay
            ...
            Case Is <= 1812
                dblFedWthTax = 100.5 + 0.25 * (dblFedWthTax - 774)
            Case Is <= 3730
                dblFedWthTax = 360 + 0.28 * (dblTaxPay - 8050)
            Case Else
    ...
    Private Sub cboAllowances_ClearOutput(sender As Object, e As EventArgs) Handles cboAllowances.TextChanged, lstHours.SelectedIndexChanged, radSingle.CheckedChanged, txtName.TextChanged
    ...
    End Sub
    Private Sub cboAllowance_KeyPress(sender As Object, e As KeyPressEventArgs) Handles cboAllowances.KeyPress
        ' Accept only number and the Backspace key.
